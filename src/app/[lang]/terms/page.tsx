...
import { termsOfServiceData } from '@/data/policies';
import { ArrowLeft, Scale, CreditCard, CheckCircle2, LifeBuoy, AlertTriangle } from 'lucide-react';
...
export default async function TermsPage({ params }: TermsPageProps) {
  ...
  const t = termsOfServiceData[lang] || termsOfServiceData.en;

  const sectionIcons = [Scale, CreditCard, CheckCircle2, LifeBuoy, AlertTriangle];
