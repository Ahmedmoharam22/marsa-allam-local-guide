...
export default function Footer({ lang }: FooterProps) {
  ...
  return (
    <footer className="bg-[#0B2538] text-slate-300 pt-16 pb-8 border-t border-slate-800/80 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800/60">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="mailto:info@example.com" aria-label="Email" className="w-11 h-11 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-300 hover:bg-amber-600 hover:text-white hover:border-amber-600 transition-all">
