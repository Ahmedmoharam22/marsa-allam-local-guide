...
//       {/* Cover Image */}
//       <div className="relative w-[120px] shrink-0 overflow-hidden bg-slate-100 dark:bg-slate-800 sm:w-44 md:h-52 md:w-full">
//         <Image
...
//       {/* Content */}
//       <div className="flex flex-1 flex-col justify-between p-3 sm:p-4 md:p-5 min-w-0 overflow-hidden">
...
//           <div className="mt-2.5 flex flex-col gap-1.5 text-xs font-medium text-slate-600 dark:text-slate-300 min-w-0 md:flex-row md:items-center md:gap-3">
...
//         <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-2.5 dark:border-slate-800/80 min-w-0 md:mt-auto md:pt-4">
...
//             className="shrink-0 rounded-xl bg-cyan-600 px-3 py-1.5 text-xs font-bold text-white transition-all hover:bg-cyan-700 active:scale-95 md:px-4 md:py-2"
//           >
//             View Details
//           </Link>
//         </div>
...
export const TourCard = ({ tour, lang }: TourCardProps) => {
  ...
  return (
    <div className="group flex flex-row items-stretch w-full min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:shadow-xl dark:border-slate-800 dark:bg-slate-900 md:flex-col">
      ...
      {/* الحل هنا: تحويل الهيكل على الديسكتوب ليستغل Aspect Ratio متناسق (16/10 أو 16/9) بدل الارتفاع الثابت */}
      <div className="relative w-[120px] shrink-0 overflow-hidden bg-slate-100 dark:bg-slate-800 sm:w-44 md:w-full md:aspect-[16/10]">
        <Image
          src={tour.images.featured}
          alt={title}
          fill
          sizes="(max-width: 768px) 176px, (max-width: 1200px) 50vw, 33vw"
