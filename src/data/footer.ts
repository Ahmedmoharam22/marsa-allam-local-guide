...
fr: {
    description: "Votre guide local de confiance à Marsa Alam, proposant des excursions professionnelles, des aventures de snorkeling et des expériences inoubliables en mer Rouge.",
    ...
    tripsTitle: "Excursions populaires",
    trips: [
      { name: "Abu Dabbab (La baie des tortues)", href: "/tours/abu-dabbab-turtle-bay-snorkeling" },
      { name: "Équitation au coucher du soleil & Nuit bédouine", href: "/tours/sunset-horse-riding-bedouin-night" },
      { name: "Récif des dauphins de Sataya", href: "/tours/sataya-reef-dolphin-snorkeling" },
      { name: "Sharm El Luli & Qulaan", href: "/tours/qulaan-mangroves-sharm-el-luli" },
    ],
    blogTitle: "Blog Marsa Alam",
    blogs: [
      { name: "Meilleure période de l'année pour la plongée", href: "/blogs/best-time-of-year-for-scuba-diving-in-marsa-alam" },
      { name: "Top 10 conseils pour les débutants en plongée", href: "/blogs/top-10-tips-for-first-time-divers-in-marsa-alam" },
      { name: "Comment choisir le meilleur centre de plongée", href: "/blogs/how-to-choose-the-best-diving-center-in-marsa-alam" },
    ],
  ...
  nl: {
    description: "Jouw betrouwbare lokale gids in Marsa Alam voor professionele tours, snorkelavonturen en onvergetelijke ervaringen in de Rode Zee.",
    ...
    tripsTitle: "Populaire tours",
    trips: [
      { name: "Abu Dabbab (Schildpaddenbaai)", href: "/tours/abu-dabbab-turtle-bay-snorkeling" },
      { name: "Paardrijden bij zonsondergang & Bedoeïenenavond", href: "/tours/sunset-horse-riding-bedouin-night" },
      { name: "Sataya Dolfijnenrif", href: "/tours/sataya-reef-dolphin-snorkeling" },
      { name: "Sharm El Luli & Qulaan", href: "/tours/qulaan-mangroves-sharm-el-luli" },
    ],
    blogTitle: "Marsa Alam Blog",
    blogs: [
      { name: "Beste reistijd voor duiken", href: "/blogs/best-time-of-year-for-scuba-diving-in-marsa-alam" },
      { name: "Top 10 tips voor beginnende duikers", href: "/blogs/top-10-tips-for-first-time-divers-in-marsa-alam" },
      { name: "Hoe kies je het beste duikcentrum", href: "/blogs/how-to-choose-the-best-diving-center-in-marsa-alam" },
    ],
  ...
  hu: {
    description: "Megbízható helyi idegenvezetőd Marsa Alamban, aki professzionális túrákat, sznorkel kalandokat és felejthetetlen Vörös-tengeri élményeket kínál.",
    quickLinksTitle: "Gyorshivatkozások",
    quickLinks: [
      { name: "Kezdőlap", href: "/" },
    ...
    tripsTitle: "Népszerű túrák",
    trips: [
      { name: "Abu Dabbab (Teknős-öböl)", href: "/tours/abu-dabbab-turtle-bay-snorkeling" },
      { name: "Naplementés lovaglás és beduin est", href: "/tours/sunset-horse-riding-bedouin-night" },
      { name: "Sataya Delfin-zátony", href: "/tours/sataya-reef-dolphin-snorkeling" },
      { name: "Sharm El Luli és Qulaan", href: "/tours/qulaan-mangroves-sharm-el-luli" },
    ],
    blogTitle: "Marsa Alam Blog",
    blogs: [
      { name: "A búvárkodás legjobb időszaka az évben", href: "/blogs/best-time-of-year-for-scuba-diving-in-marsa-alam" },
      { name: "10 fontos tipp kezdő búvároknak", href: "/blogs/top-10-tips-for-first-time-divers-in-marsa-alam" },
      { name: "Hogyan válaszd ki a legjobb búvárközpontot", href: "/blogs/how-to-choose-the-best-diving-center-in-marsa-alam" },
    ],
